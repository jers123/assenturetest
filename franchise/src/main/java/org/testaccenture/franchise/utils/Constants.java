...
public class Constants {
	...
	public static final String SUCCESSFULLY_CREATED_BRANCH = "Sucursal creado exitosamente.";
	public static final String SUCCESSFULLY_DELETED_BRANCH = "Sucursal eliminado exitosamente.";
	public static final String SUCCESSFULLY_UPDATED_BRANCH = "Sucursal actualizado exitosamente.";
	...
	public static final String SUCCESSFULLY_CREATED_FRANCHISE = "Franquicia creado exitosamente.";
	public static final String SUCCESSFULLY_DELETED_FRANCHISE = "Franquicia eliminado exitosamente.";
	public static final String SUCCESSFULLY_UPDATED_FRANCHISE = "Franquicia actualizado exitosamente.";
